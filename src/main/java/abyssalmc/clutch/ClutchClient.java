...
public class ClutchClient implements ClientModInitializer {
    ...
    public static final Identifier CLOSE_GUI_PACKET_ID = Identifier.of(Clutch.MOD_ID, "close_gui");
    public static final Identifier PY_PACKET_ID = Identifier.of(Clutch.MOD_ID, "player_y");
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (p != null && MinecraftClient.getInstance().isIntegratedServerRunning() && MinecraftClient.getInstance().getServer() != null) {
                ...
                //STALL
                if (Clutch.canParseDouble(new DecimalFormat("#.####").format(p.getY()))){
                    Clutch.currenty = Double.parseDouble(new DecimalFormat("#.####").format(p.getY()));
                }
